...
- Case design: `case-design/README.md`, `case-design/slicer-settings.md`, `case-design/BEFORE-PRINT-CHECKLIST.md`, preview images, and the printable `.3mf` files (`Case bottom.3mf`, `Case top.3mf`, `Case-slice-file.3mf`) - all public under CC BY-SA 4.0.
- Firmware: `firmware/`.
